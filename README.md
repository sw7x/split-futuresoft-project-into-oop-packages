...
**[Goto class diagram page for view all attributes of the entities](./docs/er.md)**
...
**[Goto ER diagram page for view all attributes and behaviours of the classes](./docs/cls.md)**
